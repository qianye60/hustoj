...
<html lang="en">
  <head>
    ...
    <link rel="stylesheet" href="<?php echo $cur_path?>css/welcome.css">
</head>
    ...
    <div class=wrapper>
        <div class=header>
            <div class="head clearfix">
                <div class=logo_box>
                    <h1 style="color:White;"><a href="<?php echo $path_fix?>welcome.php" style="color:white;text-decoration:none;"><?php echo $OJ_NAME?></a></h1>
                    <a href='javascript:;' class=logo_link></a>
                </div>
                <div class=nav_box id=nav_box>
                    <ul>
                        <li>
                            <a href='<?php echo $path_fix?>home.php'>主页</a>
                        </li>
                        <li>
                            <a href='<?php echo $path_fix?>problemset.php'>问题</a>
                        </li>
                        <li>
                            <a href='<?php echo $path_fix?>category.php'>分类</a>
                        </li>
                        <li>
                            <a href='<?php echo $path_fix?>contest.php'>竞赛</a>
                        </li>
                        <li>
                        ...
                        <li>
                            <a href='<?php echo $path_fix?>discuss.php'>讨论</a>
                        </li>
                        <?php } ?>
                    </ul>
        ...
        <div class=page_wp id=page_wp>
            ...
            <div class="btns_wp scale_box">
                ...
                <?php if (isset($_SESSION[$OJ_NAME.'_'.'user_id'])){?>
                    <a class="btn_download JS-btn-download" href='<?php echo $path_fix?>home.php'>进入系统</a>
                <?php }?>
            </div>
...
<script src="<?php echo $cur_path?>js/welcome.js"></script>
