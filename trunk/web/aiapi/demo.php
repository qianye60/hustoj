...
现在，请根据以上规则生成一个新的标题。";
	       ...
	       $prompt_sys='你是一个经验丰富的NOIP出题人。请根据用户给出的标题，创作一道小学生级别的编程题。

要求：
1. 题目要有生活化场景，适合小学生理解
2. 算法难度：基础循环、条件判断、简单数组
3. 必须返回纯JSON格式，不要有任何其他文字

返回格式（严格按此JSON格式，不要加```json标记）：
{"description":"题目背景和描述（包含问题定义）","input":"输入格式说明","output":"输出格式说明","sample_input":"样例输入数据","sample_output":"样例输出数据","hint":"提示和数据范围说明"}';
	$prompt_user="题目标题是:".htmlentities($title);
			}
       }
}
